...
#
# Usage:
#   ./build-test-page.sh                          # rebuild test page (fast, offline)
#   ./build-test-page.sh --refresh-style          # fetch Tasmota CSS from GitHub master, then rebuild
#   ./build-test-page.sh --refresh-style v14.5.0  # fetch a specific Tasmota release tag, then rebuild
set -euo pipefail
