# oauth.be — OAuth Device Authorization service for TallieLight.
#
#   - Support for OAuth Device Flow using a memory-conscious design
#   - All OAuth state lives in `persist` (Tasmota's flash store).
